...
$chan_webpath = "http://www.yoursite.com"; //Web path for the image board, without trailing slash
$chan_headerurl = "http://www.yoursite.com/trevorchan/trevorchanheader.jpg"; //URL to the header image (or rotation script) to be displayed, can be left blank for no image
